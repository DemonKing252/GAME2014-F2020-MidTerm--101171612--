...
Modified:   2020-10-21
Last Revision:
    Changed it so that the player only moves vertically, theres a vertical boundary on the top and bottom of the 
    screen so the player cannot leave it.
*/
public class PlayerController : MonoBehaviour
{
    ...
    private void _Move()
    {
        ...
        foreach (var touch in Input.touches)
        {
            ...
            // Change: change to switch directions based on the horizontal boundary
        ...
        {
            // Change: vertical support for regular game controls (keyboard + mouse):
